...
export const demoSongs: Song[] = [
  {
    ...
    seo_title: "Stories From The Heart | R.ON Music",
    seo_description: "A cinematic ballad demo entry from R.ON Music.",
    social_caption: "A new story begins in sound.",
    mood_tags: "cinematic, emotional, night, hope",
    release_kit: {},
    translations: {},
    cover_prompt: null,
  ...
  },
  {
    ...
    seo_title: "Electric Grace | R.ON Music",
    seo_description: "Instrumental worship textures by R.ON.",
    social_caption: "A quiet instrumental moment for reflection.",
    mood_tags: "worship, instrumental, reflective",
    release_kit: {},
    translations: {},
    cover_prompt: null,
